# Generated by Django 4.1.1 on 2022-09-30 12:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pokemon_entities', '0008_pokemon_next_evolution_pokemon_previous_evolution'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='pokemon',
            name='description',
            field=models.TextField(blank=True, null=True, verbose_name='Лписание'),
        ),
        migrations.AlterField(
            model_name='pokemon',
            name='image',
        ...
        migrations.AlterField(
            model_name='pokemon',
            name='next_evolution',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pokemon_entities_Pokemon_next_evolution', to='pokemon_entities.pokemon', verbose_name='В кого эволюционирует'),
        ),
        migrations.AlterField(
            model_name='pokemon',
            name='previous_evolution',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pokemon_entities_Pokemon_previous_evolution', to='pokemon_entities.pokemon', verbose_name='Из кого эволюционирует'),
        ),
        migrations.AlterField(
            model_name='pokemon',
            name='title',
